...
const FeatureCard: React.FC<{ 
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([entry]) => {
        // Trigger animation when at least 30% of the card is visible
  ...
  return (
    ...
    >
      {/* Thicker Glowing White Glass Layer - Increased opacity for better text contrast */}
...
export const PregnancyFeatures: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  return (
    <div className="w-full max-w-5xl mx-auto flex flex-col items-center justify-center min-h-screen py-12">
      ...
      {/* Feature Grid - Compact and Radiant */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full px-6 mb-20 items-stretch justify-center">
        ...
        <FeatureCard 
          subtitle="Clinical Vitals"
          title="Health Monitoring"
          items={[
            'Gestational Diabetes Prevention',
            'BP & Pre-eclampsia Awareness',
